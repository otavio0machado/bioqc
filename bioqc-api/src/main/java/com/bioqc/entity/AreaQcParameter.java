...
@AllArgsConstructor
@Entity
@Table(name = "area_qc_parameters")
public class AreaQcParameter {
    ...
    @Column(name = "alvo_valor", nullable = false)
    private Double alvoValor;
    ...
    @ToString.Exclude
    private List<AreaQcMeasurement> measurements = new ArrayList<>();
